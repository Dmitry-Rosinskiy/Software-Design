...
import behaviours.VisitorBehaviour1;
import behaviours.VisitorBehaviour2;
import behaviours.VisitorBehaviour3;
...
public class VisitorAgent extends BasicAgent {
    ...
    public void setup() {
        super.setup();
        addBehaviour(new VisitorBehaviour1());
        addBehaviour(new VisitorBehaviour2());
        addBehaviour(new VisitorBehaviour3());
    }
